...
rename employees menplo
rename revenues reve
...
estpost ttest $cv_m1, by(AED)
estout using nnmatch_m2_c1-4_$model.out, cells("mu_2(fmt(3) label(Mean Treated)) mu_1(fmt(3) label(Mean Control)) b(fmt(3) label(Difference)star)") label replace 
*Cantidad de paises
*tab country_n AED
...
** Pruebas de balance después del matching **
estpost ttest $cv_m1, by(AED)
estout using nnmatch_m2_c2-4_$model.out, cells("mu_2(fmt(3) label(Mean Treated)) mu_1(fmt(3) label(Mean Control)) b(fmt(3) label(Difference)star)") label replace 
*Cantidad de paises
*tab country_n AED
